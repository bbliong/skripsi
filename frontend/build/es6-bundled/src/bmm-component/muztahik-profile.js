...
</custom-style>`;document.head.appendChild($_documentContainer.content);class UploadFileElement extends(0,_myApp.ThemableMixin)(_myApp.PolymerElement){static get template(){return _myApp.html$1`
    <style>
      :host {
        display: block;
      }
...
</dom-module>`;document.head.appendChild($_documentContainer$2.content);new Promise((res,rej)=>_require.default(["./proposal.js"],res,rej)).then(bundle=>bundle&&bundle.$proposal||{});class MuztahikProfile extends _myApp.PolymerElement{static get template(){return _myApp.html`
