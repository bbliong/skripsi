define(["require","./my-app.js"],function(_require,_myApp){"use strict";_require=babelHelpers.interopRequireWildcard(_require);new Promise((res,rej)=>_require.default(["./config/loader.js"],res,rej)).then(bundle=>bundle&&bundle.$loader||{});class Login extends _myApp.PolymerElement{static get template(){return _myApp.html`
