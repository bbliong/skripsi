...
<dom-module id="paper-material-styles">
  ...
  <slot></slot>`;template$4.setAttribute("strip-whitespace","");Polymer({_template:template$4,is:"paper-button",behaviors:[PaperButtonBehavior],properties:{raised:{type:Boolean,reflectToAttribute:!0,value:!1,observer:"_calculateElevation"}},_calculateElevation:function(){if(!this.raised){this._setElevation(0)}else{PaperButtonBehaviorImpl._calculateElevation.apply(this)}}});const $_documentContainer=document.createElement("template");$_documentContainer.setAttribute("style","display: none;");$_documentContainer.innerHTML=`<iron-iconset-svg name="paper-dropdown-menu" size="24">
<svg><defs>
<g id="arrow-drop-down"><path d="M7 10l5 5 5-5z"></path></g>
</defs></svg>
</iron-iconset-svg>`;document.head.appendChild($_documentContainer.content);const template$5=html`
<custom-style>
  <style is="custom-style">
    html {
...
</custom-style>`;template$6.setAttribute("style","display: none;");document.head.appendChild(template$6.content);const $_documentContainer$1=document.createElement("template");$_documentContainer$1.setAttribute("style","display: none;");$_documentContainer$1.innerHTML=`<dom-module id="paper-dropdown-menu-shared-styles">
  <template>
    <style>
      :host {
        display: inline-block;
...
</dom-module>`;document.head.appendChild($_documentContainer$1.content);const template$7=html`<custom-style>
  <style is="custom-style">
    html {
...
</custom-style>`;template$7.setAttribute("style","display: none;");document.head.appendChild(template$7.content);const PaperInputAddonBehavior={attached:function(){this.fire("addon-attached")},update:function(state){}};var paperInputAddonBehavior={PaperInputAddonBehavior:PaperInputAddonBehavior};Polymer({_template:html`
    <style>
      :host {
        display: inline-block;
        float: right;
...
`;template$8.setAttribute("style","display: none;");document.head.appendChild(template$8.content);Polymer({_template:html`
    <style>
      :host {
        display: block;
        padding: 8px 0;
...
`,is:"paper-item",behaviors:[PaperItemBehavior]});Polymer({_template:html`
    ...
    <slot></slot>
`,is:"paper-listbox",behaviors:[IronMenuBehavior],hostAttributes:{role:"listbox"}});var currentToast=null;Polymer({_template:html`
    <style>
      :host {
        display: block;
        position: fixed;
...
</dom-module>`;document.head.appendChild($_documentContainer$3.content);const $_documentContainer$4=document.createElement("template");$_documentContainer$4.innerHTML=`<custom-style>
  <style>
    html {
...
</custom-style>`;document.head.appendChild($_documentContainer$6.content);const $_documentContainer$7=document.createElement("template");$_documentContainer$7.innerHTML=`<custom-style>
  <style>
    html {
      /* Font families */
...
</dom-module>`;document.head.appendChild($_documentContainer$7.content);const $_documentContainer$8=html`<dom-module id="lumo-button" theme-for="vaadin-button">
  <template>
    <style>
      :host {
        /* Sizing */
...
</dom-module>`;document.head.appendChild($_documentContainer$8.content);class CheckboxElement extends ElementMixin$1(ControlStateMixin(ThemableMixin(GestureEventListeners(PolymerElement)))){static get template(){return html`
    <style>
      :host {
        display: inline-block;
      }
...
</dom-module>`;document.head.appendChild($_documentContainer$a.content);class DatePickerOverlayContentElement extends ThemableMixin(ThemePropertyMixin(GestureEventListeners(PolymerElement))){static get template(){return html`
    <style>
      :host {
        display: flex;
        flex-direction: column;
...
</dom-module>`;document.head.appendChild($_documentContainer$c.content);const $_documentContainer$d=document.createElement("template");$_documentContainer$d.innerHTML=`<dom-module id="lumo-overlay">
  <template>
    <style>
      :host {
...
</dom-module>`;document.head.appendChild($_documentContainer$d.content);const $_documentContainer$e=document.createElement("template");$_documentContainer$e.innerHTML=`<dom-module id="lumo-menu-overlay-core">
  <template>
    <style>
      :host([opening]),
      :host([closing]) {
...
</dom-module>`;document.head.appendChild($_documentContainer$e.content);const $_documentContainer$f=html`<dom-module id="lumo-date-picker-overlay" theme-for="vaadin-date-picker-overlay">
  <template>
...
</dom-module>`;document.head.appendChild($_documentContainer$f.content);const $_documentContainer$g=document.createElement("template");$_documentContainer$g.innerHTML=`<custom-style>
  <style>
    @font-face {
...
</custom-style>`;document.head.appendChild($_documentContainer$g.content);const $_documentContainer$h=document.createElement("template");$_documentContainer$h.innerHTML=`<dom-module id="lumo-field-button">
  <template>
    <style>
      [part\$="button"] {
        flex: none;
...
</dom-module>`;document.head.appendChild($_documentContainer$i.content);const $_documentContainer$j=html`<dom-module id="lumo-text-field" theme-for="vaadin-text-field">
  <template>
...
</dom-module>`;document.head.appendChild($_documentContainer$j.content);const $_documentContainer$k=html`<dom-module id="lumo-date-picker" theme-for="vaadin-date-picker">
  <template>
...
</dom-module>`;document.head.appendChild($_documentContainer$k.content);const $_documentContainer$l=html`<dom-module id="lumo-month-calendar" theme-for="vaadin-month-calendar">
  <template>
    <style>
      :host {
        -moz-user-select: none;
...
</custom-style>`;document.head.appendChild($_documentContainer$l.content);const $_documentContainer$m=document.createElement("template");$_documentContainer$m.innerHTML=`<dom-module id="vaadin-dialog-overlay-styles" theme-for="vaadin-dialog-overlay">
  <template>
    <style>
      /*
...
</dom-module>`;document.head.appendChild($_documentContainer$n.content);class FormLayoutElement extends ElementMixin$1(ThemableMixin(mixinBehaviors([IronResizableBehavior],PolymerElement))){static get template(){return html`
    <style>
      :host {
        display: block;
        max-width: 100%;
...
</custom-style>`;document.head.appendChild($_documentContainer$p.content);class GridSorterElement extends ThemableMixin(PolymerElement){static get template(){return html`
    <style>
      :host {
        display: inline-flex;
        cursor: pointer;
...
</dom-module>`;document.head.appendChild($_documentContainer$q.content);const $_documentContainer$r=html`<dom-module id="lumo-grid" theme-for="vaadin-grid">
  <template>
    <style>
      :host {
        font-family: var(--lumo-font-family);
...
`}static get is(){return"vaadin-item"}static get version(){return"2.1.0"}}customElements.define(ItemElement.is,ItemElement);var vaadinItem={ItemElement:ItemElement};const $_documentContainer$s=document.createElement("template");$_documentContainer$s.innerHTML=`<dom-module id="lumo-item" theme-for="vaadin-item">
  <template>
    <style>
      :host {
        display: flex;
...
</dom-module>`;document.head.appendChild($_documentContainer$t.content);const $_documentContainer$u=document.createElement("template");$_documentContainer$u.innerHTML=`<dom-module id="vaadin-select-overlay-styles" theme-for="vaadin-select-overlay">
  <template>
    <style>
      :host {
        align-items: flex-start;
...
</dom-module>`;document.head.appendChild($_documentContainer$u.content);class SelectOverlayElement extends OverlayElement{static get is(){return"vaadin-select-overlay"}}customElements.define(SelectOverlayElement.is,SelectOverlayElement);let memoizedTemplate;class SelectTextFieldElement extends TextFieldElement{static get is(){return"vaadin-select-text-field"}static get template(){if(super.template.content.querySelector("slot[name=\"input\"]")){return super.template}if(!memoizedTemplate){memoizedTemplate=super.template.cloneNode(!0);const slot=document.createElement("slot");slot.setAttribute("name","value");const input=memoizedTemplate.content.querySelector("input");input.parentElement.replaceChild(slot,input);slot.appendChild(input)}return memoizedTemplate}get focusElement(){return this.shadowRoot.querySelector("[part=input-field]")}get inputElement(){return this.shadowRoot.querySelector("input")}}customElements.define(SelectTextFieldElement.is,SelectTextFieldElement);const $_documentContainer$v=document.createElement("template");$_documentContainer$v.innerHTML=`<custom-style>
  <style>
    @font-face {
...
</custom-style>`;document.head.appendChild($_documentContainer$v.content);class SelectElement extends ElementMixin$1(ControlStateMixin(ThemableMixin(ThemePropertyMixin(mixinBehaviors(IronResizableBehavior,PolymerElement))))){static get template(){return html`
    <style>
      :host {
        display: inline-block;
      }
...
</dom-module>`;document.head.appendChild($_documentContainer$w.content);class EmailFieldElement extends TextFieldElement{static get is(){return"vaadin-email-field"}static get version(){return"2.4.3"}ready(){super.ready();this.inputElement.type="email";this.inputElement.autocapitalize="off";this.pattern="^[a-zA-Z0-9.!#$%&\u2019*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:.[a-zA-Z0-9-]+)*$"}}customElements.define(EmailFieldElement.is,EmailFieldElement);var vaadinEmailField={EmailFieldElement:EmailFieldElement};const $_documentContainer$x=document.createElement("template");$_documentContainer$x.innerHTML=`<dom-module id="vaadin-number-field-template">
  <template>
    <style>
      :host([readonly]) {
        pointer-events: none;
...
</dom-module>`;document.head.appendChild($_documentContainer$x.content);let memoizedTemplate$1;class NumberFieldElement extends TextFieldElement{static get is(){return"vaadin-number-field"}static get version(){return"2.4.3"}static get properties(){return{hasControls:{type:Boolean,value:!1,reflectToAttribute:!0},min:{type:Number,reflectToAttribue:!0},max:{type:Number,reflectToAttribue:!0,observer:"_maxChanged"},step:{type:Number,reflectToAttribue:!0,value:1}}}static get observers(){return["_stepOrMinChanged(step, min)"]}ready(){super.ready();this.__previousValidInput=this.value||"";this.inputElement.type="number";this.inputElement.addEventListener("keydown",this.__onKeyDown.bind(this));this.inputElement.addEventListener("change",this.__onInputChange.bind(this))}_decreaseButtonTouchend(e){e.preventDefault();this._decreaseValue()}_increaseButtonTouchend(e){e.preventDefault();this._increaseValue()}static get template(){if(!memoizedTemplate$1){memoizedTemplate$1=super.template.cloneNode(!0);const thisTemplate=DomModule.import(this.is+"-template","template"),decreaseButton=thisTemplate.content.querySelector("[part=\"decrease-button\"]"),increaseButton=thisTemplate.content.querySelector("[part=\"increase-button\"]"),styles=thisTemplate.content.querySelector("style"),inputField=memoizedTemplate$1.content.querySelector("[part=\"input-field\"]"),prefixSlot=memoizedTemplate$1.content.querySelector("[name=\"prefix\"]");inputField.insertBefore(decreaseButton,prefixSlot);inputField.appendChild(increaseButton);memoizedTemplate$1.content.appendChild(styles)}return memoizedTemplate$1}_decreaseValue(){this._incrementValue(-1)}_increaseValue(){this._incrementValue(1)}_incrementValue(incr){if(this.disabled){return}let value=parseFloat(this.value);if(!this.value){if(0==this.min&&0>incr||0==this.max&&0<incr||0==this.max&&0==this.min){incr=0;value=0}else if((null==this.max||0<=this.max)&&(null==this.min||0>=this.min)){value=0}else if(0<this.min){value=this.min;if(0>this.max&&0>incr){value=this.max}incr=0}else if(0>this.max){value=this.max;if(0>incr){incr=0}else{if(this._getIncrement(1,value-this.step)>this.max){value-=2*this.step}else{value-=this.step}}}}else if(value<this.min){incr=0;value=this.min}else if(value>this.max){incr=0;value=this.max}const newValue=this._getIncrement(incr,value);if(!this.value||0==incr||this._incrementIsInsideTheLimits(incr,value)){this._setValue(newValue)}}_setValue(value){this.value=this.inputElement.value=parseFloat(value).toFixed(this.__decimals);this.dispatchEvent(new CustomEvent("change",{bubbles:!0}))}_getIncrement(incr,currentValue){let step=this.step||1,min=this.min||0;const multiplier=Math.max(this._getMultiplier(currentValue),this._getMultiplier(step),this._getMultiplier(min));step*=multiplier;currentValue*=multiplier;min*=multiplier;const margin=(currentValue-min)%step;if(0<incr){return(currentValue-margin+step)/multiplier}else if(0>incr){return(currentValue-(margin||step))/multiplier}else{return currentValue/multiplier}}_getMultiplier(number){if(!isNaN(number)){let multiplier=1;while(Math.floor(number*multiplier)!==number*multiplier){multiplier=10*multiplier}return multiplier}}_incrementIsInsideTheLimits(incr,value){if(0>incr){return null==this.min||this._getIncrement(incr,value)>=this.min}else if(0<incr){return null==this.max||this._getIncrement(incr,value)<=this.max}else{return this._getIncrement(incr,value)<=this.max&&this._getIncrement(incr,value)>=this.min}}_allowed(sign){const incr=sign*(this.step||1),value=parseFloat(this.value);return!this.value||!this.disabled&&this._incrementIsInsideTheLimits(incr,value)}_maxChanged(){this.inputElement.max=this.max}_valueChanged(newVal,oldVal){if(newVal&&isNaN(parseFloat(newVal).toFixed(this.__decimals))){this.value=""}else if("string"!==typeof this.value){this.value=this.value+""}super._valueChanged(this.value,oldVal)}__onKeyDown(e){if(38==e.keyCode){e.preventDefault();this._increaseValue()}else if(40==e.keyCode){e.preventDefault();this._decreaseValue()}}__onInputChange(){this.checkValidity()}_stepOrMinChanged(step,min){this.inputElement.step=step;this.inputElement.min=this.min;const countDecimalPlaces=number=>{return number?(Math.abs(number)+"").replace(/^\d*\.?(.*)?$/,"$1").length:0};this.__decimals=Math.max(countDecimalPlaces(step),countDecimalPlaces(min))}checkValidity(){if(this.min!==void 0||this.max!==void 0||this.step){this.invalid=!this.inputElement.checkValidity()}return super.checkValidity()}}window.customElements.define(NumberFieldElement.is,NumberFieldElement);var vaadinNumberField={NumberFieldElement:NumberFieldElement};const $_documentContainer$y=document.createElement("template");$_documentContainer$y.innerHTML=`<custom-style>
  <style>
    @font-face {
...
</dom-module>`;document.head.appendChild($_documentContainer$z.content);const $_documentContainer$A=html`<dom-module id="lumo-password-field" theme-for="vaadin-password-field">
  <template>
    <style>
...
</dom-module>`;document.head.appendChild($_documentContainer$A.content);const $_documentContainer$B=html`<dom-module id="lumo-text-area" theme-for="vaadin-text-area">
  <template>
...
</dom-module>`;document.head.appendChild($_documentContainer$B.content);const data={},subscribers={},EVENTS={SET:"set",SUBSCRIBE:"subscribe",UNSUBSCRIBE:"unsubscribe"},_notify=(event,detail,path="")=>{const pathSubscribers=subscribers[path]||[],wildCardSubscribers=subscribers["*"]||[];[...pathSubscribers,...wildCardSubscribers].forEach(subscriber=>{subscriber._onEvent(event,detail)})},_addSubscriber=(path,subscriber)=>{subscribers[path]=subscribers[path]||[];subscribers[path].push(subscriber)},_deleteSubscriber=(path,subscriber)=>{const index=subscribers[path].indexOf(subscriber);if(0<=index)subscribers[path].splice(index,1);if(0===subscribers[path].length)delete subscribers[path]},get$1=path=>data[path],set$1=(path,value)=>{if(data[path]===value){return}const{SET}=EVENTS;data[path]=value;_notify(SET,{path,value},path)},subscribe=(path,subscriber)=>{const{SUBSCRIBE}=EVENTS;_addSubscriber(path,subscriber);_notify(SUBSCRIBE,{path,element:subscriber})},unsubscribe=(path,subscriber)=>{if(!subscribers[path]){return}const{UNSUBSCRIBE}=EVENTS;_deleteSubscriber(path,subscriber);_notify(UNSUBSCRIBE,{path,element:subscriber})},isSubcribed=subscriber=>Object.entries(subscribers).reduce((acc,[path,subs])=>subs.contains(subscriber)?path:acc,!1);var globalData={EVENTS,get:get$1,set:set$1,subscribe,unsubscribe,isSubcribed},globalData$1={default:globalData};class GlobalData extends PolymerElement{static get properties(){return{}}static get template(){return html`
      <style>
        :host {
          display: none;
        }
      </style>
    `}connectedCallback(){super.connectedCallback();globalData.subscribe("*",this)}disconnectedCallback(){super.disconnectedCallback();globalData.unsubscribe("*",this)}_onEvent(event,detail){this.dispatchEvent(new CustomEvent(event,{detail}))}set(path,value){globalData.set(path,value)}get(path){return globalData.get(path)}}customElements.define("global-data",GlobalData);class GlobalVariable extends PolymerElement{static get properties(){return{_notify:{type:Function,computed:"_notifyOrigin(key, readonly)"},key:{type:String,reflectToAttribute:!0,observer:"_subscribe"},value:{notify:!0,observer:"_notify"},readonly:{type:Boolean,value:!1,reflectToAttribute:!0}}}static get template(){return html`
      <style>
        :host {
          display: none;
        }
      </style>
    `}disconnectedCallback(){super.disconnectedCallback();globalData.unsubscribe(this.key,this)}_notifyOrigin(key,readonly){return newValue=>{if(!readonly){globalData.set(key,newValue)}}}_subscribe(newKey,oldKey){if(newKey!=oldKey&&oldKey){globalData.unsubscribe(oldKey,this)}globalData.subscribe(newKey,this);this.set("value",globalData.get(newKey))}_onEvent(event,detail){const{SET}=globalData.EVENTS;if(event===SET){this._set(detail)}}_set(value){this.set("value",value.value)}}customElements.define("global-variable",GlobalVariable);const $_documentContainer$C=document.createElement("template");$_documentContainer$C.innerHTML=`<dom-module id="custom-css">
  <template>
    <style>
...
</dom-module>`;document.head.appendChild($_documentContainer$C.content);const $_documentContainer$D=document.createElement("template");$_documentContainer$D.innerHTML=`<iron-iconset-svg name="my-icons" size="24">
  <svg>
    <defs>
      <g id="arrow-back">
...
</iron-iconset-svg>`;document.head.appendChild($_documentContainer$D.content);setPassiveTouchGestures(!0);setRootPath(MyAppGlobals.rootPath);class MyApp extends PolymerElement{static get template(){return html`
    ...
    `}static get properties(){return{page:{type:String,reflectToAttribute:!0,observer:"_pageChanged"},routeData:Object,subroute:Object}}static get observers(){return["_routePageChanged(routeData.page)"]}_routePageChanged(page){if(!page){this.page="login"}else if(-1!==["panel","login"].indexOf(page)){this.page=page}else{this.page="view404"}}_pageChanged(page){switch(page){case"login":import("./login.js").then(bundle=>bundle&&bundle.$login||{});break;case"panel":import("./panel.js").then(bundle=>bundle&&bundle.$panel||{});break;}}}window.customElements.define("my-app",MyApp);const $_documentContainer$E=document.createElement("template");$_documentContainer$E.innerHTML=`<dom-module id="shared-styles">
  <template>
    <style>
      .card {
        margin: 24px;
