import{PolymerElement,html}from"../my-app.js";import("../config/loader.js").then(bundle=>bundle&&bundle.$loader||{});class User extends PolymerElement{static get template(){return html`
