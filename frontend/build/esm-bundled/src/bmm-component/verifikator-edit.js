import{PolymerElement,html as html$1,FlattenedNodesObserver,ThemableMixin,CheckboxElement,html$1 as html}from"../my-app.js";class CheckboxGroupElement extends ThemableMixin(PolymerElement){static get template(){return html`
    <style>
      :host {
        display: inline-flex;
      }
...
</dom-module>`;document.head.appendChild($_documentContainer.content);class VerifikatorEdit extends PolymerElement{static get template(){return html$1`
