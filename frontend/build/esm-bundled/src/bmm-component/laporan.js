import{PolymerElement,html}from"../my-app.js";import("../config/loader.js").then(bundle=>bundle&&bundle.$loader||{});class Laporan extends PolymerElement{static get template(){return html`
