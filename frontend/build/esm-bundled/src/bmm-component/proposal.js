import{PolymerElement,html as html$1,OverlayElement,ElementMixin,FlattenedNodesObserver,ThemePropertyMixin,html$1 as html}from"../my-app.js";const $_documentContainer=document.createElement("template");$_documentContainer.innerHTML=`<dom-module id="vaadin-dialog-overlay-styles" theme-for="vaadin-dialog-overlay">
  <template>
    <style>
      /*
...
</dom-module>`;document.head.appendChild($_documentContainer.content);class DialogOverlayElement extends OverlayElement{static get is(){return"vaadin-dialog-overlay"}}customElements.define(DialogOverlayElement.is,DialogOverlayElement);class DialogElement extends ThemePropertyMixin(ElementMixin(PolymerElement)){static get template(){return html`
    <style>
      :host {
        display: none;
      }
...
</dom-module>`;document.head.appendChild($_documentContainer$1.content);import("../config/loader.js").then(bundle=>bundle&&bundle.$loader||{});class Proposal extends PolymerElement{static get template(){return html$1`
