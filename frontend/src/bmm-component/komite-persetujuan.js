...
class KomitePersetujuan extends PolymerElement {
  static get template() {
    return html`
            ...
            for (var i = 0; i < cloneKadiv.length ; i++){
              if(typeof kadivData[i] != "undefined"){
                ...
                cloneKadiv[i] = {
                  ...
                  "status" :   kadivData[i].status.toString(),
                  "tanggal" :  tanggal,
                }
              }
            }
              ...
              if(typeof pengurusData[i] != "undefined"){
                ...
                if(this.formatDate(new Date(pengurusData[i].tanggal)) !== "1-1-1" ){
                  ...
                  clonePengurus[i] = {
                    ...
                    "status" :   pengurusData[i].status.toString(),
                    "tanggal" :  tanggal,
                  }
              }
             }
              ...
              for (var i = 0; i < clonePengawas.length ; i++){
                if(typeof pengawasData[i] != "undefined"){
                  ...
                  pengawasData[i] = {
                      ...
                      "status" :   pengawasData[i].status.toString(),
                      "tanggal" :  tanggal,
                    }
                }
              }
    ...
    convertData(data){
      ...
      for (i = data.length - 1; i >= 0; i -= 1) {
        ...
        if(typeof data[i] !== "undefined"){
          // ubah status jadi integer
          data[i].status = parseInt(data[i].status)

          // delete tanggal karna ambil dari golang
          delete data[i].tanggal

          // filter data id menjadi user 
