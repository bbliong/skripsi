      ...
      :host([disabled]) [part="label"] {
        ...
        <div class="card">
            <div class="wrap">
                <vaadin-form-layout>
                    ...
                    <vaadin-text-field label="Judul Proposal" value="{{regObj.judul_proposal}}"  disabled colspan="2"></vaadin-text-field>
        ...
        <dom-repeat items="{{pihakKonfirmasi}}" id="konfirmasi">
            <template>
                    <div class="card">
                        <div class="wrap">
                        <h3> Pihak Diverfikasi / Dikonfirmasi  [[displayIndex(index)]] </h3>
